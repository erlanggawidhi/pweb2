...
class MahasiswaController
{
    ...
    {
        return $this->model->createMahasiswa($nim, $nama, $jenis_kelamin, $program_studi, $alamat);
    }
    ...
    {
        return $this->model->updateMahasiswa($id, $nim, $nama, $jenis_kelamin, $program_studi, $alamat);
    }
